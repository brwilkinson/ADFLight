...
@{
    AllNodes = @(
        @{
            ...
            EnvironmentVarSet           = @(
                @{Prefix = 'AzureSettings:'; KVName = '{0}-kvGlobal'; Name = 'BotName' },
                @{Prefix = 'AzureSettings:'; KVName = '{0}-kvGlobal'; Name = 'AadAppId' },
                @{Prefix = 'AzureSettings:'; KVName = '{0}-kvGlobal'; Name = 'AadAppSecret' },
                @{Prefix = 'AzureSettings:'; KVName = '{0}-kvGlobal'; Name = 'ServiceDnsName' },
                @{Prefix = 'AzureSettings:'; KVName = '{0}-kvGlobal'; Name = 'SpeechConfigKey' },
                @{Prefix = 'AzureSettings:'; KVName = '{0}-kvGlobal'; Name = 'CertificateThumbprint' },
                @{Prefix = 'AzureSettings:'; KVName = '{0}-kvGlobal'; Name = 'Prefix' },
                @{Prefix = 'AzureSettings:'; KVName = '{0}-kvGlobal'; Name = 'OrgName' },
                @{Prefix = 'AzureSettings:'; KVName = '{0}-kvGlobal'; Name = 'App' },
                @{Prefix = 'AzureSettings:'; KVName = '{0}-kvGlobal'; Name = 'Environment' }
            )
