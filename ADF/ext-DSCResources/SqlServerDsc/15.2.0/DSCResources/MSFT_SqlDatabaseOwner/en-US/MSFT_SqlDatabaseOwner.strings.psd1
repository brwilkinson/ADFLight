ConvertFrom-StringData @'
    GetCurrentDatabaseOwner = THIS RESOURCE IS DEPRECATED! Get the current owner of the database '{0}' on the instance '{1}'.
    ...
    SetDatabaseOwner = THIS RESOURCE IS DEPRECATED! Setting a new owner of the database '{0}' on the instance '{1}'.
